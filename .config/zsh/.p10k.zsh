# Generated by Powerlevel10k configuration wizard on 2020-08-07 at 18:27 CEST.
...
# 24h time, round separators, round heads, round tails, 1 line, compact, many icons,
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=045
