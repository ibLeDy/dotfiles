...
cp $DOTFILES_CONFIG_HOME/sublime-text/Packages/User/{'Default (Linux).sublime-keymap','Package Control.sublime-settings',Preferences.sublime-settings} ~/.config/sublime-text/Packages/User/
...
# $HOME/.local/bin
mkdir -p ~/.local/bin
# cp $DOTFILES_LOCAL_BIN/{countdown,extramaus,fix-volume,mute-spotify-ads} ~/.local/bin/
