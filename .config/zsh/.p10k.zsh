# Generated by Powerlevel10k configuration wizard on 2020-02-12 at 17:19 CET.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 44204.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=038
  ...
  # typeset -g POWERLEVEL9K_VIRTUALENV_BACKGROUND=044
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=004
